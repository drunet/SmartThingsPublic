...
preferences {
        input("ip", "string", title:"IP Address", description: "10.0.2.157", defaultValue: "10.0.2.157" ,required: true, displayDuringSetup: true)
...
metadata {
	definition (name: "Raspberry Pi", namespace: "drunet", author: "Drew Smith") {
		capability "Polling"
		capability "Refresh"
